...
namespace Ramblers\Component\Ra_walks_editor\Administrator\View\Walks;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_RA_WALKS_EDITOR_TITLE_WALKS'), "generic");
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_ra_walks_editor&view=walks');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`date`' => Text::_('COM_RA_WALKS_EDITOR_WALKS_DATE'),
			'a.`id`' => Text::_('JGRID_HEADING_ID'),
			'a.`category`' => Text::_('COM_RA_WALKS_EDITOR_WALKS_CATEGORY'),
			'a.`status`' => Text::_('COM_RA_WALKS_EDITOR_WALKS_STATUS'),
		);
	}
