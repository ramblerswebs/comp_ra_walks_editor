 ...
 * @since  1.0.0
 */
class PlacesModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		parent::populateState('a.abbr', 'ASC');
		...
		$ordering  = $this->getUserStateFromRequest($this->context .'.filter_order', 'filter_order', 'a.abbr');
	...
	protected function getListQuery()
	{
			...
			$query->from('`#__ra_walks_editor_places` AS a');
		...
		else
		{
			...
			$orderCol  = $this->state->get('list.ordering', 'a.abbr');
