...
class ContactsModel extends ListModel
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$ordering  = $this->getUserStateFromRequest($this->context .'.filter_order', 'filter_order', 'a.checked_out');
	...
	protected function getListQuery()
	{
			...
			$query->from('`#__ra_walks_editor_contacts` AS a');
		...
		else
		{
			...
			$orderCol  = $this->state->get('list.ordering', 'a.checked_out');
