...
<div class="contact-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-contact"
			  action="<?php echo Route::_('index.php?option=com_ra_walks_editor&task=contactform.save'); ?>"
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_ra_walks_editor&task=contactform.cancel'); ?>"
