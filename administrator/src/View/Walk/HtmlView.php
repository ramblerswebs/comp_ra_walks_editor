...
namespace Ramblers\Component\Ra_walks_editor\Administrator\View\Walk;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_RA_WALKS_EDITOR_TITLE_WALK'), "generic");
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			ToolbarHelper::versions('com_ra_walks_editor.walk', $this->item->id);
		}
